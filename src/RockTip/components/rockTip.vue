...
import { priceFormatter } from '@/RockTip/utilities/priceFormatter';
import { Translations } from '@/RockTip/constants/translations';
import { Attributes } from '@/RockTip/constants/attributes';
...
<style variant="static">
:root {
    --rockTip-font: Verdana, Arial, sans-serif;
    --rockTip-static--color-border: hsl(50deg, 35%, 50%);
    --rockTip-static--color-text: hsl(0, 0%, 100%);
}
...
.rockTip {
    ...
    font-size: 0.70rem;
    border: 0.20rem double var(--rockTip-static--color-border);
    height: fit-content;
    width: fit-content;
...
.rockTip > .tip-wrapper > .tip-wrapper > .inner {
    padding: 0.30rem;
}

.rockTip > .tip-wrapper > .corners {
    position: absolute;
    height: 100%;
    width: 100%;
}

.rockTip > .tip-wrapper > .corners > .leftTop {
    position: absolute;
    height: 1.313rem;
    width: 2.188rem;
    left: -0.35rem;
...
.rockTip > .tip-wrapper > .corners > .rightBottom {
    position: absolute;
    height: 1.313rem;
    width: 2.188rem;
    bottom: -0.35rem;
...
<style variant="other">
:root {
    --rockTip-other--background-mask: url(data:image/png;base64,);
    --rockTip-other--corner-right: url(data:image/png;base64,);
    --rockTip-other--corner-left: url(data:image/png;base64,);
    --rockTip-other--color-bless: hsl(40deg, 100%, 50%);
    --rockTip-other--color-clan: hsl(50deg, 100%, 50%);
...
<style variant="html">
:root {
    --rockTip-html--background-mask: url(data:image/jpeg;base64,);
    --rockTip-html--corner-right: url(data:image/png;base64,);
...
<style variant="npc">
:root {
    --rockTip-npc--background-mask: url(data:image/png;base64,);
    --rockTip-npc--corner-right: url(data:image/png;base64,);
    --rockTip-npc--corner-left: url(data:image/png;base64,);

    --rockTip-npc--color-adventage-high: hsl(0deg, 0%, 65%);
    --rockTip-npc--color-adventage-low: hsl(20deg, 100%, 50%);
    --rockTip-npc--color-level: hsl(50deg, 100%, 50%);
...
.rockTip[data-type='npc'] > .tip-wrapper > .inner > .group {
  justify-content: center;
  display: flex;
  height: fit-content;
  width: 100%;
